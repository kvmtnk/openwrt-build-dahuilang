...
# 后台IP设置
export Ipv4_ipaddr="172.31.10.1"            # 修改openwrt后台地址(填0为关闭)
...
export Customized_Information="SDWAN $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
git clone https://github.com/kenzok8/small-package/tree/main/luci-app-npc
